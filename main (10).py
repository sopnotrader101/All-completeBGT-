...
# Bot Token
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8467555740:AAEqBWpnxN7aQrc0TgD15W_LDeiDSOllMcY")
...
async def check_account_frozen(client):
    ...
    Method 1: API restriction flags on the User object → 'frozen'
    Method 2: SpamBot live check — reads NEW messages after /start → 'spam' or None
    """
...
async def handle_pin_input(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    try:
        ...
        try:
            account_status = await check_account_frozen(client)
        except Exception as e:
...
async def handle_2fa_input(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    try:
        ...
        try:
            account_status_2fa = await check_account_frozen(client)
        except Exception as e:
